...
describe('StormGlass client', () => {
  ...
  it('debe devolver la data normalizada del servicio StormGlass', async () => {
    const lat = -33.792726;
  ...
  it('debe excluir el punto de datos incompleto', async () => {
    const lat = -33.792726;
    const lng = 151.289824;
  ...
  it('should get an StormGlassResponseError when the StorGlass service responds with error', async () => {
    const lat = -33.792726;
    const lng = 151.289824;
